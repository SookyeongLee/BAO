...
<body onLoad="init()">
    ...
    <section class="profile mypage">
        <div class="profile__container">
            ...
            <form name="" action="" method="POST" id="jun">
                <table class="profile__info"> 
                    ...
                    <tr class="profile__list">
                        ...
                        <td class="profile__contents"><input class="profile__input" type="password" id="pw" name="mPw"></td>
                    </tr>
                    <tr class="profile__list">
                    ...
                    <tr class="profile__list">
                        ...
                        <td class="profile__contents"><input class="profile__input" type="text" id="region" name="mRegion"></td>
                    </tr>
                    <tr class="profile__list">
                        <th class="profile__title"><label for="division">소속</label></th>
                        <td class="profile__contents"><input class="profile__input" type="text" id="division" name="mDivision"></td>
                    <tr/>
                    <tr class="profile__list">
                ...
                <div class="mypage__bottom">
                    <button type="button"  class="mypage__btn"  onClick="UpdateProfile()">수정하기</button>
                </div>
            </form>
        </div>
    </div>
...
// 		var mDivision = document.getElementsByName ("mDivision")[0];
...
// 		}
	...
	function UpdateProfile(){
		...
		let  pw =document.getElementById("pw").value;
         ...
         var form = document.createElement("form");
   		var form = document.getElementById("jun");
          alert("ㅎㅇ");
          form.action ="Main?pw="+pw;
          form.method ="POST";        
